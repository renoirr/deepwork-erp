...
딥워크의 업무를 한 곳에서 관리하는 웹앱입니다. 3가지 축으로 구성됩니다.

| 축 | 내용 | 상태 |
| --- | --- | --- |
| 업무 자동화툴 | 유튜브 원고 자동화 | 사용 가능 |
| | 이미지 생성 (1000×1000) | 준비중 |
| | 상세페이지 자동화 | 준비중 |
| 매출관리 | 채널별 매출 집계·리포트 | 준비중 |
| 광고 지표관리 | 광고비·ROAS·전환 추적 | 준비중 |
...
- 화면: `app/automation/youtube-script/page.tsx`
- 서버 로직: `app/api/generate-script/route.ts`
- 원고 작성 규칙과 도입부 템플릿 30종: `lib/prompts/youtube-script.ts` — 규칙을 바꾸고 싶으면 이 파일만 수정하면 됩니다.
